...
function productAiGuidance(productRaw, scenarioRaw = '') {
  ...
  const scenarioHints = {
    ...
    executor_attestation_call: [
      ...
      '',
      'client_message — сообщение клиенту (3-6 предложений):\n- Обращение по имени\n- 1-2 предложения что обсудили (услуга, схема специалистов кратко)\n- Список документов — используй ТОЛЬКО поле context.document_list.docs, не придумывай своё. Перечисли ключевые позиции (диплом, трудовая, аттестат на каждого специалиста). Не переписывай весь перечень дословно — выбери самое важное.\n- Одна фраза что делаем мы (готовим пакет, записываем в Белстройцентр и т.д.)\n- Никогда не упоминай название мессенджера (Viber/Telegram/WhatsApp) — пиши "пришлите мне"',
      '',
